...
if( !empty($_POST['btn_confirm']) ) {
  ...
  $admin_reply_text = null;
	...
	$header .= "From: nskk <nskk@gmail.com>\n";
	$header .= "Reply-To: nskk <nskk@gmail.com>\n";
...
下記の内容でお問い合わせを受け付けました。\n\n";
  ...
  $admin_reply_text .= "お問い合わせ内容" . nl2br($_POST['contents']) . "\n";
	...
	// 運営側へメール送信
	mb_send_mail( 'nskk@gmail.com', $admin_reply_subject, $admin_reply_text, $header);
}
?>
...
<form method="post" action="">
	...
	<div class="element_wrap">
		<label>問い合わせ内容</label>
		<textarea type='text' name='contents'><?php if(!empty($_POST['contents'])){echo $_POST['contents'];}?></textarea>
	</div>
	<div class="element_wrap">
